...
def build_about_admin_text() -> str:
	lines = [
		...
		escape_markdown_v2("  • Статистика по активным и завершенным урокам."),
		escape_markdown_v2("  • Возможность выбрать определенный урок"),
		"",
		escape_markdown_v2("Условные обозначения в системе табеля:"),
		"",
		escape_markdown_v2("🟢 -  На момент отчета урок завершен"),
		escape_markdown_v2("🟡 -  На момент отчета урок активный"),
		escape_markdown_v2("🔴 -  На момент отчета урок не начат"),
		"",
		escape_markdown_v2("✅ -  Есть ответ студента на активный или завершенный урок"),
		escape_markdown_v2("❌ -  Нет ответа студента на активный или завершенный урок"),
	]
	return "\n".join(lines)
