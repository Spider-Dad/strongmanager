...
- [ ] БД инициализирована (`python db/init_database.py` выполнен успешно)
- [ ] Справочные данные заполнены через DBeaver
- [ ] Тестовое подключение из бота работает
- [ ] Представления (views) доступны и работают
- [ ] Триггеры `updated_at` обновляют дату
- [ ] Все изменения закоммичены в ветку
- [ ] Ветка протестирована локально
